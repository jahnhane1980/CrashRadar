...
Im Rahmen der Konzeption wurden alle relevanten Marktdaten-Provider auf ihre Eignung und Datenverfügbarkeit im Free-Tier untersucht und live getestet (Skripte: [`scratch/test_sources.js`](file:///D:/GitHub/CrashRadar/scratch/test_sources.js), [`scratch/test_modern_fmp.js`](file:///D:/GitHub/CrashRadar/scratch/test_modern_fmp.js), [`scratch/test_forexfactory.js`](file:///D:/GitHub/CrashRadar/scratch/test_forexfactory.js) und [`scratch/parse_cleveland.js`](file:///D:/GitHub/CrashRadar/scratch/parse_cleveland.js)):
...
Zur Validierung der Dynamisierung wurde ein Simulations-Skript ([`scratch/simulate_dynamic_rules.js`](file:///D:/GitHub/CrashRadar/scratch/simulate_dynamic_rules.js)) entwickelt, das die realen historischen FRED-Zeitreihen aus `econ_fred` lädt, die gleitenden 3-Monats-Durchschnitte (3M MA) berechnet und den statischen JSON-Werten gegenüberstellt:
