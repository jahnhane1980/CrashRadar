...
* 📄 **[`Indicator-Trigger-Report.md`](file:///D:/GitHub/CrashRadar/docs/research/macro-proofs/Indicator-Trigger-Report.md):**  
  *Empirischer Krisen-Trigger-Report: Analyse der exakten Vorlaufzeiten aller Kern-Frühwarnindikatoren (Margin Debt, Zinskurven-Un-Inverting, TGA Drain, VIX Spike & Crush) über die 6 großen Bärenmärkte (Dotcom 2000, Finanzkrise 2007, Zins-Panik 2018, Corona 2020, Inflationsschock 2022, Crash 2025).*
* 📄 **[`Indicator-Backtest-Log.md`](file:///D:/GitHub/CrashRadar/docs/research/macro-proofs/Indicator-Backtest-Log.md):**  
  *Chronologisches Backtest-Log des Fiscal-FED-Indikators vs. S&P 500 (2006–2013): Detaillierte Rekonstruktion aller 4 Phasenwechsel (Staubsauger-Warnung, Crash, BORROW-Panik, WRESBAL-Rettung).*
