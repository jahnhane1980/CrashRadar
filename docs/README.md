...
* 📄 **[`Gold-SPY.md`](file:///D:/GitHub/CrashRadar/docs/architecture/strategies/Gold-SPY.md):**  
  *Quantitative Makro-Schild & Tranchen-Strategie für dynamisches DCA im S&P 500: Reines DCA im Normalbetrieb, 100 % Notfall-Evakuierung in 50 % Gold / 50 % Cash bei Makro ROT (NetLiq Delta < -5 % & Credit Spreads > 4 %) und antizyklischer Bottom-Sniper Re-Entry inkl. 21,8-Jahre-Historien-Stresstest (2004–2026: 296.212 € mit Gold-Schutz vs. 233.922 € reines Gold) in [`GoldSpyFullHistorySimulation.js`](file:///D:/GitHub/CrashRadar/scratch/architecture/strategies/GoldSpyFullHistorySimulation.js).*
