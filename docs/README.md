...
* 📄 **[`Gold-SPY.md`](file:///D:/GitHub/CrashRadar/docs/architecture/strategies/Gold-SPY.md):**  
  *Quantitative Trend-Schild & Gold-Hedge-Strategie (Version 2.1) für dynamisches DCA im S&P 500: Reines DCA im Normalbetrieb, Notfall-Evakuierung in 75 % Gold / 25 % Cash bei Trendbruch (SPY < SMA 200 & Drawdown >= 8 %) als Margin-Call-Airbag mit antizyklischem VIX-Panik-Boden-Sniper inkl. 21,8-Jahre-Historien-Beweis (2004–2026: 356.944 € / +624 % Rendite / +26k € Alpha vs. SPY) in [`test_75_25_gold_spy.js`](file:///D:/GitHub/CrashRadar/scratch/architecture/strategies/test_75_25_gold_spy.js).*
