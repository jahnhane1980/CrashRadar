...
* 📄 **[`Gold-SPY.md`](file:///D:/GitHub/CrashRadar/docs/architecture/strategies/Gold-SPY.md):**  
  *Quantitative Trend-Schild & Gold-Hedge-Strategie für dynamisches DCA im S&P 500: Reines DCA im Normalbetrieb, 100 % Notfall-Evakuierung in physisches Gold (GLD) bei Trendbruch (SPY < SMA 200 & Drawdown >= 8 %) und antizyklischer VIX-Panik-Boden-Sniper inkl. 21,8-Jahre-Historien-Beweis (2004–2026: 448.497 € mit Trend- & Gold-Hedge vs. 306.045 € Buy & Hold = +142.451 € Alpha) in [`GoldSpyFullHistorySimulation.js`](file:///D:/GitHub/CrashRadar/scratch/architecture/strategies/GoldSpyFullHistorySimulation.js).*
