...
* 📄 **[`Kamikaze-Growth.md`](file:///D:/GitHub/CrashRadar/docs/architecture/strategies/Kamikaze-Growth.md):**  
  *50/50 Kamikaze-Growth-Strategie auf nativer US-Dollar-Basis ($ 30.000 Startpool + $ 10.000 Cash-Pot + 200 $/Monat BTC-Sparplan): 50 % Tech Sub-Bucket & 50 % Krypto-Equity Sub-Bucket im S&P 500 Mutterschiff, User-kuratierte Watchlist (`OBSERVE`), BTC-USD 21-Wochen-EMA Master-Regime mit 40/30/30-Pyramide und Krypto-Claim-Compounder, Weinstein Stage-2-Gate, 'Kein Kauf ohne SEC-10-Q'-Fundamental-Türsteher, Sektor-Relativität, Flag-System mit 3-Stufen-Abbau, konträres Dip-Buying, 100 % Notfall-Evakuierung in 50 % Gold / 50 % Cash mit Re-Entry-Sniper (+781,11 % Nettorendite / $ 477.560,07 vs. SPY +152,27 % und BTC +487,96 %) sowie detaillierte empirische Watchlist-Analyse (`SOFI`, `NVTS`, `IBRX`, `S`) und Turnaround-/Biotech-Lehren inkl. PoC in [`KamikazeGrowthSimulation.js`](file:///D:/GitHub/CrashRadar/scratch/architecture/strategies/KamikazeGrowthSimulation.js).*
