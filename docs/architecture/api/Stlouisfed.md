...
Die FRED-Datenreihen bilden das Rückgrat der makroökonomischen Analyse:
* **Storage-Adapter:** [`FredAdapter.js`](file:///D:/GitHub/CrashRadar/src/core/adapters/storage/FredAdapter.js) in `src/core/adapters/storage/`.
* **Task-Konfiguration:** [`config/Database-Fetcher-Config.json`](file:///D:/GitHub/CrashRadar/config/Database-Fetcher-Config.json) (Provider `FRED`, URL-Template `/fred/series/observations`, Batch-Limit 100.000).
* **CLI- & Backfill-Tool:** [`tools/backfill_new_fred_series.js`](file:///D:/GitHub/CrashRadar/tools/backfill_new_fred_series.js) für automatisches Nachladen beliebiger historischer Reihen.
* **Unit-Tests:** [`FredAdapter.test.js`](file:///D:/GitHub/CrashRadar/tests/core/adapters/storage/FredAdapter.test.js).
* **MySQL-Zieltabelle:** `econ_fred` (Primary Key: `series_id`, `observation_date`).
