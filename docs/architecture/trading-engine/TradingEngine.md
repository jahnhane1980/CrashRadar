...
* 🏛️ **Mathematische Formeln & Geldmarkt-Plumbing:**  
  🔗 [docs/architecture/macro/Treasury-Liquidity-Capacity-Architecture.md](file:///D:/GitHub/CrashRadar/docs/architecture/macro/Treasury-Liquidity-Capacity-Architecture.md)  
  *(Formeln zu Liquid Slack, LCLOR, TGA-Cushion, Buyback-Netting und Kollisions-Timer)*

* 🧠 **Zentrale Makro-Thesen & Mythos-Buster:**  
  🔗 [docs/research/macro-proofs/Analyse.md](file:///D:/GitHub/CrashRadar/docs/research/macro-proofs/Analyse.md)  
...
Als nächster Schritt wird ein dediziertes Simulations-Skript (`scratch/architecture/trading-engine/full_21y_trading_engine_backtest.js`) entwickelt, das diesen genauen Investitionsstil gegen historische Daten testet:
...
Extreme FINRA-Leerverkaufsdaten wirken sich je nach Aktie und Bilanzstruktur massiv unterschiedlich aus (dokumentiert in [`docs/research/ml-lab/ML_EVALUATIONS.md`](file:///D:/GitHub/CrashRadar/docs/research/ml-lab/ML_EVALUATIONS.md)):
...
* **Komponenten-Entwurf:**
  ...
  3. `src/analysis/indicators/MacroScenarioIndicator.js`: Szenario-Regime-Indikator (siehe [`docs/architecture/macro/Makro-Kalender-Szenarien-Konzept.md`](file:///D:/GitHub/CrashRadar/docs/architecture/macro/Makro-Kalender-Szenarien-Konzept.md)), der den aktuellen Score (z. B. Goldilocks vs. Stagflation) an die Engine meldet.
