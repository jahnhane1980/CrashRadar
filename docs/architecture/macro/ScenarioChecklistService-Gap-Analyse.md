...
| :--- | :--- | :--- | :--- |
| **1. DDL & Migration** | [`docs/architecture/database/Macro-Calendar-Events.md`](file:///D:/GitHub/CrashRadar/docs/architecture/database/Macro-Calendar-Events.md) | **MySQL Schema für `macro_calendar_events`:**<br>• Spalten: `id`, `category`, `subcategory`, `title`, `event_date`, `event_time`, `status`, `criticality`, `metadata_json`, `actual_value`, `details_json`, `source`, Timestamps.<br>• Indizes: `idx_event_date`, `idx_category_status`, `idx_subcategory`. | ✅ Umgesetzt |
