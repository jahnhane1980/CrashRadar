...
* **Gold als Notgroschen:** In klassischen Panik-Crashes (2000, 2008) steigt Gold stark an (+16% bis +24%). Bei abrupten Liquiditäts- oder Inflationsschocks (2020, 2022) fällt Gold anfangs zwar ebenfalls ab, da Investoren alles zu Cash machen müssen (Margin Calls), verliert aber deutlich weniger an Wert als Aktien.
...
* **Fazit:** Wenn Gold aufhört zu fallen und einen Aufwärtstrend ausbildet, signalisiert dies, dass der Liquiditätsengpass im System behoben wurde. Es ist der verlässlichste Indikator dafür, dass der Aktienmarkt bald seinen Tiefpunkt ("Boden") findet.
...
* **Der "Maturity-Wall" Indikator (T-Bill Rollover):** Dieser Indikator misst die Refinanzierungslast der USA (T-Bills, die in den nächsten 3 Monaten fällig werden) im Verhältnis zur gesamten Geldmenge M2. Er warnt uns vor massiven Liquiditäts-Schocks.
  * *Normale Baseline (< 10 %):* Historisch (2000-2020) lag die Last immer bei ca. 8-10% der M2. Der Markt absorbiert das problemlos.
  * *Warn-Zone (> 12 %):* Das System beginnt zu ächzen. (Beispiel: 2022 kletterte die Rate auf über 14 %, Yellen saugte den Markt leer, Aktien und Krypto stürzten ab).
  * *Roter Alarm (> 15 %):* Extreme "Refinancing Cliff". (Beispiel: Vor dem Crash 2025 und aktuell in 2026 liegen wir bei wahnwitzigen **> 21 %** der M2). In dieser Zone ist der Aktienmarkt auf Sand gebaut, weil jederzeit ein misslungener Anleihen-Verkauf das TGA explodieren lässt.
...
#### 4. Absichtlich ignorierte Indikatoren
