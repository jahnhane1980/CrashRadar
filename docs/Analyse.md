...
* **Empirischer Beweis (Der Stealth-Exit Test):** Ein Backtest (`scratch/analyse/test_stealth_exit_theory.js`) mit realen, historischen SqueezeMetrics-Daten (2011-2026) hat die Dark-Pool-Divergenz nun empirisch bewiesen.
...
* **Die Überprüfung:**
  * **Empirische Auswertung Zinsinversion & Schuldenzyklus (1970–2026):** Eine historische Event-Studie über 7 Zyklen seit 1970 (siehe Quant-Backtest [scratch/validate_dalio_thesis.py](file:///D:/GitHub/CrashRadar/scratch/validate_dalio_thesis.py)) beweist:
  ...
  * **Backtest "3 von 4 Indikatoren ROT" & Kipppunkt-Kaskade (1970–2026):** Der historische Backtest aller Marktphasen seit 1970 (siehe Quant-Backtest [scratch/test_3_of_4_system.py](file:///D:/GitHub/CrashRadar/scratch/test_3_of_4_system.py)) untersucht das gleichzeitige Anschlagen von 3 von 4 Makro-Bedingungen (Zinsdruck, Zinsinversion, Kreditrisiko, Schuldenquote):
