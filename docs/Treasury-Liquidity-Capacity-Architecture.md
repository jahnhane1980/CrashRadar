...
Die empirische Untersuchung über 3.183 Handelstage (2014 bis heute) wurde mit dem Skript [`scratch/analyze_treasury_capacity_model.js`](file:///D:/GitHub/CrashRadar/scratch/analyze_treasury_capacity_model.js) durchgeführt und in [`scratch/capacity_model_results.json`](file:///D:/GitHub/CrashRadar/scratch/capacity_model_results.json) persistiert.
