...
> **Master-Architektur:** Dieses Dokument ist die quantitative Regelwerk-Spezifikation innerhalb des übergeordneten Frameworks [`Single-Asset-Radar-Architecture.md`](file:///D:/GitHub/CrashRadar/docs/single-asset-radar/Single-Asset-Radar-Architecture.md). Für den technischen Datenbezug der Kerzen siehe [`M5Candels.md`](file:///D:/GitHub/CrashRadar/docs/single-asset-radar/M5Candels.md).
