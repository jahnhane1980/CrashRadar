...
* **SEC 10-Q Fundamentaldaten:** Quartalsberichte aus der SEC Company Facts API für Umsatzwachstum (YoY) und Net Income ab 2009 in [`data/cache/strategies/fundamentals_master.json`](file:///D:/GitHub/CrashRadar/data/cache/strategies/fundamentals_master.json).
