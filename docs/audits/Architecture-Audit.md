...
Dieser Audit-Report dokumentiert die Divergenzen zwischen der theoretischen Makro-Forschung ([`docs/macro/Analyse.md`](file:///D:/GitHub/CrashRadar/docs/macro/Analyse.md)) und der tatsächlichen Implementierung in der CrashRadar-Engine (`src/analysis/`). 
