...
async function runGrandBacktest() {
  ...
  // Speichern
  fs.writeFileSync(
    path.resolve(process.cwd(), 'data/cache/macro/full_21y_backtest_results.json'),
    JSON.stringify({ greenStats, yellowStats, redStats, crisisReport }, null, 2),
    'utf8'
  );

  console.log('[Erfolg] Alle 21-Jahre-Ergebnisse in data/cache/macro/full_21y_backtest_results.json persistiert.');
}
