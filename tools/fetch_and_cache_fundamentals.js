...
const outDir = path.resolve(__dirname, '../data/cache/strategies/fundamentals');
...
async function fetchAndCacheFundamentals() {
    ...
    console.log("================================================================================");
    console.log("   CRASHRADAR FUNDAMENTALS CACHER (Polygon.io -> data/cache/strategies)");
    ...
    // Save unified master file in data/cache/strategies/fundamentals_master.json
    const masterPath = path.resolve(__dirname, '../data/cache/strategies/fundamentals_master.json');
