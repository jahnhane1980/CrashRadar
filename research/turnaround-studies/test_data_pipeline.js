...
const SHARED_CACHE_DIR = path.resolve(__dirname, '../../data/cache/strategies');
const SHARED_FUNDAMENTALS_PATH = path.resolve(__dirname, '../../data/cache/strategies/fundamentals_master.json');
