...
const PLTR_DAILY_PATH = path.join(REPO_ROOT, 'data/cache/turnarounds/PLTR_daily.json');
const QQQ_DAILY_PATH = path.join(REPO_ROOT, 'data/cache/strategies/QQQ_2014-10-01_2026-09-06.json');
const SEC_FACTS_PATH = path.join(REPO_ROOT, 'data/cache/turnarounds/PLTR_sec_facts.json');
const M5_PATH = path.join(REPO_ROOT, 'data/cache/turnarounds/pltr_m5_rth_aggregated.json');
