...
async function runFiscalShieldBacktest() {
  ...
  // Speichere Rohdaten
  fs.writeFileSync('data/cache/portfolio_compass/adr007_test_results.json', JSON.stringify({
    totalElectionsAnalyzed: results.length,
    pastMidtermsCount: pastMidterms.length,
    events: results
  }, null, 2));

  console.log('\n✅ Ergebnisse erfolgreich in data/cache/portfolio_compass/adr007_test_results.json gespeichert!');
