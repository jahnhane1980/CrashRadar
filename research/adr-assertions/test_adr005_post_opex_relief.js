...
async function runPostOpexReliefBacktest() {
  ...
  fs.writeFileSync('data/cache/portfolio_compass/adr005_test_results.json', JSON.stringify({
  ...
  console.log('✅ Ergebnisse erfolgreich in data/cache/portfolio_compass/adr005_test_results.json gespeichert!');
