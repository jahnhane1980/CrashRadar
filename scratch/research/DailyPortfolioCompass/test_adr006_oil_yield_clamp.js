...
async function runOilYieldClampBacktest() {
  ...
  fs.writeFileSync('scratch/research/DailyPortfolioCompass/adr006_test_results.json', JSON.stringify({
  ...
  console.log('✅ Ergebnisse erfolgreich in scratch/research/DailyPortfolioCompass/adr006_test_results.json gespeichert!');
