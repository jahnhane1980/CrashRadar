...
async function runDualGatekeeperBacktest() {
  ...
  fs.writeFileSync('scratch/research/DailyPortfolioCompass/adr004_test_results.json', JSON.stringify({
  ...
  console.log('✅ Ergebnisse erfolgreich in scratch/research/DailyPortfolioCompass/adr004_test_results.json gespeichert!');
