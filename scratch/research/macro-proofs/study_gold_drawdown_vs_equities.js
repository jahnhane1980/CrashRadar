...
const gldData = JSON.parse(fs.readFileSync(path.join(ROOT_DIR, 'scratch/trash/cache/GLD_2004-11-18_2026-09-08.json'), 'utf-8'));
const spyData = JSON.parse(fs.readFileSync(path.join(ROOT_DIR, 'scratch/trash/cache/SPY_2004-11-18_2026-09-08.json'), 'utf-8'));
const qqqData = JSON.parse(fs.readFileSync(path.join(ROOT_DIR, 'scratch/trash/cache/QQQ_2014-10-01_2026-09-06.json'), 'utf-8'));
